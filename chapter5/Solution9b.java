...
public class Solution9b {
	...
	public static void main(String[] args) {
		...
		Coordinate c = findElement(matrix, 110);
		System.out.println(110 + ": (" + c.row + ", " + c.column + ")");
	...
	public static Coordinate findElement(int[][] matrix, Coordinate origin, Coordinate dest,int x){
		...
		return findPartition(matrix,origin,dest,start,x);
	}
	
	public static Coordinate findPartition(int[][] matrix, Coordinate origin, Coordinate dest, Coordinate pivot,int x){
